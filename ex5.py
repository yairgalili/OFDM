...
def simulate_sm_zf(snr_db_values, Nrx, Ntx, num_symbols=100000):
    ser = []
...
if __name__ == "__main__":
	...
	results_zf_22 = simulate_sm_zf(SNR_dB, 2, 2)
	results_zf_42 = simulate_sm_zf(SNR_dB, 4, 2)
	
	results_sm_22 = simulate_sm_qpsk(SNR_dB, 2, 2)
